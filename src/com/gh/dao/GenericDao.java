...
public interface GenericDao<E extends Serializable, PK extends Serializable> {
	 ...
	 * @return
	 */
	List<E> find(String hql,int firstResult,int maxResults);
	/**
	 * 带参数的分页查询
	 * @param hql
	 * @param firstResult
	 ...
	 * @return
	 */
	List<E> find(String hql,int firstResult,int maxResults,Object... values);
	/**
	 *  通过hql查询实体个数
	 * @param hql
	 * @param params
	 ...
	 * @return
	 */
	List<Object[]> findByObj(String hql,int firstResult,int maxResults,Object... values);
	/**
	 * 
	 * @param queryName
	 *            使用带参数的命名hql语句进行查询
